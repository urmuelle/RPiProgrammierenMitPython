# Kapitel 6, 6.6.2 Karteikasten: Erweiterung des Editors
...
label = Label(master=window, width=20, font = ("Arial", 14), text="Keine Karten geladen")
buttonNext = Button(master=window,
                text="Speichern und weiter", width=20,
                font = ("Arial", 14), command=nextCard)
buttonNew = Button(master=window, text="Neue Karte", 
                width=20, font = ("Arial", 14),
                command=newCard)
buttonLoad = Button(master=window, text="Laden", 
                width=12, font = ("Arial", 12),
                command=loadCards)
buttonNewCards = Button(master=window, text="Neue Kartei", 
                width=12, font = ("Arial", 12),
                command=newCards)
text1 = Text(master=window, width=40, height=4,
             font = ("Arial", 14), wrap=WORD)
text2 = Text(master=window, width=40, height=4,
             fg="blue", font = ("Arial", 14), wrap=WORD)
